...
<p>Для остановки сервера через режим командной строки нажмите сочетание клавиш Windows + R и пропишите команду cmd, затем в появившемся окне введите команду: taskkill /f /IM nginx.exe и нажмите Enter</p>
