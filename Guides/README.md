...
<p>Чтобы остановить сервер через режим командной строки (для активации которого нажмите клавишу Windows + R и пропишите cmd) введите команду: taskkill /f /IM nginx.exe</p>
