...
<ol>
    <li>
        <p>Переходим на по <a href="https://nginx.ru/ru/download.html">ссылке</a> и скачиваем <b>стабильную версию</b>.</p>
    </li>
    <p><img src="img/ins_nginx.png" alt=""></p>
    <li>
        <p>Распакуем файлы из архива в папку <b>nginx</b>, которая находится в папке <b>server</b>.</p>
    </li>
</ol>
